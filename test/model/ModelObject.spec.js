...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterpriseReportingV3ApIsPreview.ModelObject();
  });
  ...
  describe('ModelObject', function() {
    it('should create an instance of ModelObject', function() {
      ...
      //var instane = new EnterpriseReportingV3ApIsPreview.ModelObject();
      //expect(instance).to.be.a(EnterpriseReportingV3ApIsPreview.ModelObject);
    });
