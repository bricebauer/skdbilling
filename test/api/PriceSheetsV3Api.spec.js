...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EnterpriseReportingV3ApIsPreview.PriceSheetsV3Api();
  });
  ...
  describe('PriceSheetsV3Api', function() {
    describe('priceSheetsV3Get', function() {
      it('should call priceSheetsV3Get successfully', function(done) {
        //uncomment below and update the code to test priceSheetsV3Get
        //instance.priceSheetsV3Get(function(error) {
    ...
    describe('priceSheetsV3Get_0', function() {
      it('should call priceSheetsV3Get_0 successfully', function(done) {
        //uncomment below and update the code to test priceSheetsV3Get_0
        //instance.priceSheetsV3Get_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
